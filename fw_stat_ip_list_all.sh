...
#FIREWALLS="."
FIREWALLS="firewall01"
#FIREWALLS="firewall01 firewall02 firewall03"
...
if ((  $# < 2 )); then
        echo "Usage: $0 ip_list_file cp_firewall_log-1.txt.gz cp_firewall_log-2.txt.gz ..."
        exit 1
fi
...
do
        echo "==================== $fw ==========================="
        zcat $files | fgrep $fw | egrep -v ";drop;|;reject;|;control;|;udp;123;|;icmp" | egrep "$iplist" | awk -F\; '
